/*
 https://sketch.io/js/ColorSphereBackground.js
 */
...
var ColorSphereBackground = function(params) {
    ...
    this.create = function(params) {
        ...
        canvas.style.cssText = "position: absolute; left: 0; top: 0; opacity: 1; z-index: -1";
        ...
        Event.add(window, "resize", function() {
            ...
            canvas.style.height = Math.max(window.innerHeight, element.offsetHeight) + "px";
            ctx.drawImage(theSphere = that.sphere(params, canvas, percent), 0, 0)
        });
    };
    ///
    this.sphere = function(params, canvas, top) { // create Sphere image, and apply to <canvas>
        ...
        while (n--) { // go through hues
            ...
            g.addColorStop(.5, "hsl(" + ((n + 60) % 360) + ",100%,100%)");
